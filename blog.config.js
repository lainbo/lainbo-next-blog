...
const BLOG = {
  ...
  FONT_URL: [
    ...
    'https://use.sevencdn.com/css?family=Inter&display=swap',
    'https://use.sevencdn.com/css2?family=JetBrains+Mono&display=swap',
  ],
  ...
  PRISM_THEME_LIGHT_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH || 'https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-M/prism-themes/1.9.0/prism-vsc-dark-plus.min.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || 'https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-M/prism-themes/1.9.0/prism-vsc-dark-plus.min.css', // 深色模式主题
  ...
  WIDGET_PET_LINK:
    ...
    'https://fastly.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_CDN_URL:
        ...
        'https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-M/aplayer/1.10.1/APlayer.min.js',
  ...
  COMMENT_ARTALK_JS:
    ...
    'https://s4.zstatic.net/ajax/libs/artalk/2.5.5/Artalk.js', // ArtalkServert js cdn
  COMMENT_ARTALK_CSS:
    process.env.NEXT_PUBLIC_COMMENT_ARTALK_CSS ||
    'https://s4.zstatic.net/ajax/libs/artalk/2.5.5/Artalk.css', // ArtalkServert css cdn
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://s4.zstatic.net/ajax/libs/twikoo/1.6.17/twikoo.min.js', // twikoo客户端cdn
  ...
  COMMENT_GITALK_JS_CDN_URL:
    ...
    'https://fastly.jsdelivr.net/npm/gitalk@1/dist/gitalk.min.js', // gitalk客户端 js cdn
  COMMENT_GITALK_CSS_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CSS_CDN_URL ||
    'https://fastly.jsdelivr.net/npm/gitalk@1/dist/gitalk.css', // gitalk客户端 css cdn
  ...
  ANIMATE_CSS_URL:
    ...
    'https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-M/animate.css/4.1.1/animate.min.css', // 动画CDN
