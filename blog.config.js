...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lainbo.com', // 网站地址
  ...
  FONT_URL: [
    ...
    'https://font.alnk.cn/css2?family=Noto+Sans+SC:wght@300&display=swap',
    'https://font.alnk.cn/css2?family=Noto+Serif+SC:wght@300&display=swap'
  ],
  ...
  FONT_AWESOME: process.env.NEXT_PUBLIC_FONT_AWESOME_PATH || 'https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/font-awesome/6.4.0/css/all.min.css', // font-awesome 字体图标地址; 可选 /css/all.min.css ， https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css
  ...
  // START********代码相关********
  // PrismJs 代码相关
  PRISM_JS_PATH: 'https://cdnjs.webstatic.cn/ajax/libs/prism/1.29.0/components/',
  PRISM_JS_AUTO_LOADER: 'https://cdnjs.webstatic.cn/ajax/libs/prism/1.29.0/plugins/autoloader/prism-autoloader.min.js',
  ...
  PRISM_THEME_LIGHT_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH || 'https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/prism-themes/1.9.0/prism-vsc-dark-plus.min.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || 'https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/prism-themes/1.9.0/prism-vsc-dark-plus.min.css', // 深色模式主题
  ...
  // Mermaid 图表CDN
  MERMAID_CDN: process.env.NEXT_PUBLIC_MERMAID_CDN || 'https://cdnjs.webstatic.cn/ajax/libs/mermaid/10.2.4/mermaid.min.js', // CDN
  // QRCodeCDN
  QR_CODE_CDN: process.env.NEXT_PUBLIC_QR_CODE_CDN || 'https://cdnjs.webstatic.cn/ajax/libs/qrcodejs/1.0.0/qrcode.min.js',
  ...
  WIDGET_PET_LINK:
        ...
        'https://npm.webcache.cn/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  COMMENT_ARTALK_JS: process.env.NEXT_PUBLIC_COMMENT_ARTALK_JS || 'https://cdnjs.webstatic.cn/ajax/libs/artalk/2.5.5/Artalk.js', // ArtalkServert js cdn
  COMMENT_ARTALK_CSS: process.env.NEXT_PUBLIC_COMMENT_ARTALK_CSS || 'https://cdnjs.webstatic.cn/ajax/libs/artalk/2.5.5/Artalk.css', // ArtalkServert css cdn
  ...
  COMMENT_GITALK_JS_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_GITALK_JS_CDN_URL || 'https://npm.webcache.cn/gitalk@1/dist/gitalk.min.js', // gitalk客户端 js cdn
  COMMENT_GITALK_CSS_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_GITALK_CSS_CDN_URL || 'https://npm.webcache.cn/gitalk@1/dist/gitalk.css', // gitalk客户端 css cdn

  COMMENT_GITTER_ROOM: process.env.NEXT_PUBLIC_COMMENT_GITTER_ROOM || '', // gitter聊天室 see https://gitter.im/ 不需要则留空
  COMMENT_DAO_VOICE_ID: process.env.NEXT_PUBLIC_COMMENT_DAO_VOICE_ID || '', // DaoVoice http://dashboard.daovoice.io/get-started
  COMMENT_TIDIO_ID: process.env.NEXT_PUBLIC_COMMENT_TIDIO_ID || '', // [tidio_id] -> //code.tidio.co/[tidio_id].js

  COMMENT_VALINE_CDN: process.env.NEXT_PUBLIC_VALINE_CDN || 'https://npm.webcache.cn/valine@1.5.1/dist/Valine.min.js',
