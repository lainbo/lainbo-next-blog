...
export const MenuItemCollapse = (props) => {
  ...
  return <>
        <div className={ (selected ? 'bg-[#1677FF] text-white hover:text-white' : 'hover:text-[#1677FF]') + ' px-7 w-full text-left duration-200 dark:bg-hexo-black-gray dark:border-black'} onClick={toggleShow} >
